...
// it. Uses a simple name to ensure compatibility across all browsers and
// redirect flows (including mobile browsers where __Host- cookies may be
// blocked during cross-origin OAuth redirects).
